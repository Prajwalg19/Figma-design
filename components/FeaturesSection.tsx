            ...
            <motion.div ref={ref} initial={{opacity: 0, x: 35}} whileInView={{opacity: 1, x: 0, transition: {duration: 0.6}}} viewport={{once: true}} className="font-custom relative tracking-wider mt-0 lg:mt-8 flex flex-col lg:flex-row gap-10 lg:gap-20 w-full px-4">
                ...
                <div className="mt-14 flex flex-col gap-8 w-full">
                    <section className="flex flex-col gap-2">
                        <p className="text-orange-500 text-center lg:text-left text-2xl font-clashMedium">Features</p>
                        <h1 className="font-extrabold text-3xl text-center lg:text-left sm:text-4xl lg:text-5xl font-clashBold">Urify Premium</h1>
                    </section>
                    <section className="flex flex-col gap-2">
                        <p className="text-lg font-semibold flex flex-row gap-2 justify-center lg:justify-start items-center font-clashSemiBold">
                            <IoCubeOutline className="text-orange-500 font-semibold text-2xl" />
                            <span >Budgeting Intervals</span>
                        </p>
                        <h1 className="text-center lg:text-left text-gray-600 dark:text-gray-300/90 font-clashMedium">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Adipisci ea obcaecati vel assumenda, rem repellat et vitae.</h1>
                    </section>
                    <section className="flex flex-col gap-2">
                        <p className="text-lg font-semibold flex flex-row gap-2 justify-center lg:justify-start items-center">
                            ...
                            <span className="font-clashSemiBold">Budgeting Intervals</span>
                        </p>
                        <h1 className="text-center lg:text-left font-clashMedium text-gray-600 dark:text-gray-300/90">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Adipisci ea obcaecati vel assumenda, rem repellat et vitae.</h1>
                    </section>
                    <section className="flex flex-col gap-2">
                        <p className="text-lg font-semibold flex font-clashSemiBold flex-row gap-2 justify-center lg:justify-start items-center">
                            <TbBrandPrisma className="text-orange-500 font-semibold text-2xl" />
                            <span>Budgeting Intervals</span>
                        </p>
                        <h1 className="font-clashMedium text-center lg:text-left text-gray-600 dark:text-gray-300/90">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Adipisci ea obcaecati vel assumenda, rem repellat et vitae.</h1>
                    </section>
                </div>
